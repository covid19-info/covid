function getDailyCases() {
    
    let path = "data/WHO-COVID-19-global-data.csv";
    let dailyCases = [];
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            for (let i = 1; i < rows.length; i++) {
                ...
                dailyCases.push([convertCountryToCode(data[2]),Number.parseInt(data[4])]);
             }
        }
    }
...
function getWorldNewCasesIn7Days() {
    let path = "data/WHO-COVID-19-global-table-data.csv";
    let newCases = [];
    let xhr = new XMLHttpRequest();
